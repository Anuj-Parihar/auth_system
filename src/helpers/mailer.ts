...
export const sendEmail = async ({email, emailType, userId}:any) =>{
    try {
        ...
        const mailOptions = {
            ...
            html: `<p>Click <a href="${process.env.DOMAIN}/verifyemail?token${hashToken}">here</a> to ${emailType === "VERIFY" ? "verify your email" : "reset your password"} or copy and paste link below in your browser <br> ${process.env.DOMAIN}/verifyemail?token=${hashToken} </p>`
        }
